...
@warning_ignore("unused_signal") signal pickup_upgrade_done
@warning_ignore("unused_signal") signal player_died
@warning_ignore("unused_signal") signal level_up(levels_gained: int, current_level : int)
@warning_ignore("unused_signal") signal modifiers_changed(modifiers : ModifiersResponse)
...
@warning_ignore("unused_signal") signal update_upgrade_choices(choices : Array[UpgradeData])
@warning_ignore("unused_signal") signal ui_chose_upgrade(upgrade : UpgradeData)
@warning_ignore("unused_signal") signal update_status_screen(data : PlayerStatusData)
